 ...
 <div class="todo">
		...
		<ul>
			...
			>
				...
				/>
				<span :class="{completed: todo.completed}" class="help-block">{{ todo.text }}</span>
				<button @click="removeTodo(todo)">x</button>
        <el-button type="text" @click="exportTodo(todo)">Export</el-button>
				</li>
</ul>
		<div>
			<a
...
import {
  mapGetters,
  mapMutations
} from 'vuex' // IMPORT ALWAYS ON TOP OF THE SCRIPT
